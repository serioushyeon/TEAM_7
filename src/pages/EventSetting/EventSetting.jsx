            ...
            <div className="eventSetting">
                ...
                <form className='eventForm'>
                    <div className="wrapper">
                        <div className='titleWrapper'><div className='title'>Event</div></div>
                    ...
                    <div className="wrapper">
                        <div className='titleWrapper'><div className='title'>Start Date</div></div>
                        <div className="inputWrap">
                            <DatePicker
                                className='input'
                    ...
                    <div className="wrapper">
                        <div className='titleWrapper'><div className='title'>End Date</div></div>
                        <div className="inputWrap">
                            <DatePicker
                                    className='input'
                                    dateFormat="yyyy-MM-dd"
                ...
                <div className='eventMake'>
                    <button className='eventMakeBtn' onClick={goToEventDisplay}>이벤트 생성</button>
                </div>
            </div>
        </>
    );
